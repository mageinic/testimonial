...
interface TestimonialSearchResultsInterface extends SearchResultsInterface
{
     ...
     * Set title list.
     *
     * @param \MageINIC\Testimonial\Api\Data\TestimonialInterface[] $items
     * @return $this
     */
    public function setItems(array $items): TestimonialSearchResultsInterface;
}
