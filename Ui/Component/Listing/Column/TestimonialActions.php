...
/**
 * Class for TestimonialActions
 */
class TestimonialActions extends Column
{
    public const URL_PATH_EDIT = 'testimonial/testimonial/edit';
    public const URL_PATH_DELETE = 'testimonial/testimonial/delete';
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure, wan\'t to delete this record?')
                            ]
                        ]
                    ];
                }
